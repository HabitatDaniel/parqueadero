...
<head>
    ...
    <link rel="stylesheet" href="../../css/styles-bootstra5Registro.css">
</head>
...
<body>
    ...
    if (isset($_GET['placa']) && !empty(trim($_GET['placa']))) {
        ...
        if ($vehiculo = $resultado->fetch_assoc()) {
            ...
            echo "<p><strong>Placa:</strong> " . htmlspecialchars($vehiculo['Placa']) . "</p>";
            ...
            echo "<p><strong>Id Conductor:</strong> " . htmlspecialchars($vehiculo['IdConductor']) . "</p>";
            ...
            //$nombre_foto = $vehiculo['Placa'] . ".JPG";
            $nombre_fotoLateral =  "FotoLateral.JPG";
            ...
            echo "<img src='" . htmlspecialchars($ruta_completa_foto) . "' alt='Foto del vehículo' style='max-width: 200px; height: auto; border: 2px solid #ccc; border-radius: 8px;'>";
            echo "<img src='" . htmlspecialchars($ruta_completa_fotoLateral) . "' alt='Foto del vehículo' style='max-width: 200px; height: auto; border: 2px solid #ccc; border-radius: 8px;'>";
